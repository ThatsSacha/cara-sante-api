...
<img src="https://www.carasante.com/wp-content/uploads/2021/04/logocarasante-e1450701241142.png" alt="ship" style="display: block;" title="ship" width="150">
    ...
    public function getSaveDatabase(): string {
        return '
        <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office"><head> 
  <meta charset="UTF-8"> 
  <meta content="width=device-width, initial-scale=1" name="viewport"> 
...
<img src="https://www.carasante.com/wp-content/uploads/2021/04/logocarasante-e1450701241142.png" alt="ship" style="display: block;" title="ship" width="150">
                ...
                </div><h2 style="color: #333333; font-family: \'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;">Voici la sauvegarde de la base de données !</h2></td> 
                     </tr> 
                     <tr class="ui-draggable"> 
                      <td class="esd-block-text es-m-txt-l es-p20t esd-frame esd-draggable esd-block esd-hover esdev-disable-select" align="left" esd-handler-name="textElementHandler" contenteditable="true"><div class="esd-block-btn " contenteditable="false">
                    <div class="esd-more"><a><span class="es-icon-dot-3"></span></a></div>
                ...
                </div><p style="font-size: 16px; color: #777777;">En pièce-jointe, le fichier de base de données qui fait fonctionner toute l\'application Liora, utilisateurs, patients, tests Covid à sauvegarder dans un endroit sécurisé hors-ligne.</p></td> 
                     </tr> 
                     <tr class="ui-draggable"> 
                      <td class="esd-block-button es-p25t es-p20b es-p10r es-p10l esd-frame esdev-disable-select esd-draggable esd-block esd-hover" align="center" esd-handler-name="btnBlockHandler"><div class="esd-block-btn">
                    <div class="esd-more"><a><span class="es-icon-dot-3"></span></a></div>
     ...
     * @return string
     */
    public function getContactTemplate(array $data, Users $user): string {
        return '
        <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office"><head> 
  <meta charset="UTF-8"> 
  <meta content="width=device-width, initial-scale=1" name="viewport"> 
...
<img src="https://www.carasante.com/wp-content/uploads/2021/04/logocarasante-e1450701241142.png" alt="ship" style="display: block;" title="ship" width="150">
                ...
                </div><h2 style="color: #333333; font-family: \'open sans\', \'helvetica neue\', helvetica, arial, sans-serif;">Demande de contact par '. $user->getFirstName() .' ' . $user->getLastName() . '</h2></td> 
                     </tr> 
                     <tr class="ui-draggable"> 
                      <td class="esd-block-text es-m-txt-l es-p20t esd-frame esd-draggable esd-block esd-hover esdev-disable-select" align="left" esd-handler-name="textElementHandler" contenteditable="true"><div class="esd-block-btn " contenteditable="false">
                    <div class="esd-more"><a><span class="es-icon-dot-3"></span></a></div>
                ...
                </div><p style="font-size: 16px; color: #777777;">Sujet : '. $data['subject'] .'</p><br/><br/><p style="font-size: 16px; color: #777777;">Message : <br/><em>'. $data['message'] .'</em></p></td>
                </div></td>
                     </tr> 
                     <tr class="ui-draggable"> 
                      <td class="esd-block-button es-p25t es-p20b es-p10r es-p10l esd-frame esdev-disable-select esd-draggable esd-block esd-hover" align="center" esd-handler-name="btnBlockHandler"><div class="esd-block-btn">
